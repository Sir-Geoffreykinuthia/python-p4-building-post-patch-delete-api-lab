...
# @app.route('/baked_goods', methods=['POST'])
# def create_baked_good():
#     baked_good_data = request.form
#     new_baked_good = BakedGood(name=baked_good_data['name'], price=data['price'], bakery_id=data['bakery_id'])
#     db.session.add(new_baked_good)
#     db.session.commit()
...
#         db.session.delete(baked_good)
#         db.session.commit()
#         return make_response({"result": "Baked good deleted"}, 200)
#     else:
